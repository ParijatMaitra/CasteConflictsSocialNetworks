// Dyads - Caste to caste(within castes) networks at the village level, REDS 2006//
...
* However, due to peculiar naming conventions unique to each Indian states, reshaping the data using the caste names proved to be a bit of a challenge.
...
* Joining the reshapeed dataset(row castes) with the column castes.
...
* converting the castecodes to string & renaming them as c_castecode
...
* generating the village level total within-caste links
